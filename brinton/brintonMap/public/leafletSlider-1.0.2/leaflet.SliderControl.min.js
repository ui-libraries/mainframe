L.Control.SliderControl=L.Control.extend({options:{position:"bottomleft",
layers:null,timeAttribute:'time',isEpoch:false,maxValue:-1,minValue:-1,markers:null,range:!1,follow:!1},
...
$(b).append('<div id="leaflet-slider" style="width:600px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:600px; font-size:18px; margin-top:-30px;background-color:#FFFFFF"></div></div>'),
